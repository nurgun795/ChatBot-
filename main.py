...
async def handle_request(request: Request):
    ...
    # based on the structure of the WebhookRequest from Diologflow
...
# step 3: remove the food items . request: ["vada pov", "pizza"]

"Removed vada pav from order. Rava dosa not found in your order."
# session_id_1
# ============
#
# I need 2 pizza and one samosa --> add_to_order --> {"pizza":2, "samosa": 1}
# oh well, add one mango lassi --> {"pizza": 2, "samosa": 1, "mango lassi": 1}
